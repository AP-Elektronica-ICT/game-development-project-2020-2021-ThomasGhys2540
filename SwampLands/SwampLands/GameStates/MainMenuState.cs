...
namespace SwampLands
{
    class MainMenuState : State
    {
        ...
        {
            var PlayButton = new Button("Sprites\\UI\\Buttons\\PlayButton", new Rectangle(((int)Globals.ScreenWidth / 2) - 75, 100, 150, 150));
            var SettingsButton = new Button("Sprites\\UI\\Buttons\\SettingsButton", new Rectangle(((int)Globals.ScreenWidth / 2) - 75, 350, 150, 150)); 
            var QuitButton = new Button("Sprites\\UI\\Buttons\\QuitButton", new Rectangle(((int)Globals.ScreenWidth / 2) - 75, 600, 150, 150));
